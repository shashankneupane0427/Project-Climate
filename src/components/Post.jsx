...
const Post = ({ thumbnail, authorID, title, id, authorProfilePic }) => {
    return (
        <div className="relative rounded-2xl border-gray-200 border-2 overflow-hidden shadow-md transition-shadow duration-300 hover:shadow-lg w-[350px] lg:w-[370px]">
